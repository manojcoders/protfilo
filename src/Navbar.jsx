...
const Navbar = () => {
  ...
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between relative">
        ...
        {/* Nav Items */}
        <ul className={`${menuOpen ? "flex" : "hidden"} sm:flex absolute sm:static top-16 left-1/2 sm:left-auto transform sm:transform-none -translate-x-1/2 sm:translate-x-0 
